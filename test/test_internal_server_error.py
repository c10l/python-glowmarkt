...
from python_glowmarkt.models.internal_server_error import InternalServerError  # noqa: E501
...
class TestInternalServerError(unittest.TestCase):
    ...
    def testInternalServerError(self):
        ...
        # model = python_glowmarkt.models.internal_server_error.InternalServerError()  # noqa: E501
        pass
