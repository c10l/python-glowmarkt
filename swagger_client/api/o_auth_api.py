...
class OAuthApi(object):
    ...
    def exchange_authorization_code_with_access(self, client_id, client_secret, code, grant_type, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.exchange_authorization_code_with_access_with_http_info(client_id, client_secret, code, grant_type, **kwargs)  # noqa: E501
        else:
            (data) = self.exchange_authorization_code_with_access_with_http_info(client_id, client_secret, code, grant_type, **kwargs)  # noqa: E501
            return data

    def exchange_authorization_code_with_access_with_http_info(self, client_id, client_secret, code, grant_type, **kwargs):  # noqa: E501
        """Exchange the Authorization Code for an Access Token.  # noqa: E501
        ...
        if ('client_id' not in params or
            ...
            raise ValueError("Missing the required parameter `client_id` when calling `exchange_authorization_code_with_access`")  # noqa: E501
        # verify the required parameter 'client_secret' is set
        if ('client_secret' not in params or
                params['client_secret'] is None):
            raise ValueError("Missing the required parameter `client_secret` when calling `exchange_authorization_code_with_access`")  # noqa: E501
        # verify the required parameter 'code' is set
        if ('code' not in params or
                params['code'] is None):
            raise ValueError("Missing the required parameter `code` when calling `exchange_authorization_code_with_access`")  # noqa: E501
        # verify the required parameter 'grant_type' is set
        if ('grant_type' not in params or
                params['grant_type'] is None):
            raise ValueError("Missing the required parameter `grant_type` when calling `exchange_authorization_code_with_access`")  # noqa: E501
    ...
    def generate_o_authorization_code(self, body, application_id, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.generate_o_authorization_code_with_http_info(body, application_id, **kwargs)  # noqa: E501
        else:
            (data) = self.generate_o_authorization_code_with_http_info(body, application_id, **kwargs)  # noqa: E501
            return data

    def generate_o_authorization_code_with_http_info(self, body, application_id, **kwargs):  # noqa: E501
        """Authenticate a user and generate an OAuth 2.0 Authorization Code Grant.  # noqa: E501
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `generate_o_authorization_code`")  # noqa: E501
        # verify the required parameter 'application_id' is set
        if ('application_id' not in params or
                params['application_id'] is None):
            raise ValueError("Missing the required parameter `application_id` when calling `generate_o_authorization_code`")  # noqa: E501
